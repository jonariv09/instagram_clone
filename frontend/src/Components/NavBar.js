...
import { Compass, Heart, Instagram, Search, User } from 'react-feather'
            ...
            <div className={'row'}>
              ...
              <div className={'col-4 d-flex justify-content-center align-items-center'}>
                ...
                <div className="ml-auto wrapper-nav-icons d-flex justify-content-around align-items-center">
                  ...
                  <svg aria-label="Buscar personas" className="_8-yf5 "
                  ...
                  <svg aria-label="Feed de actividades" className="_8-yf5 "
                       fill="#262626" height="24" viewBox="0 0 48 48"
                       width="24">
                    <path clip-rule="evenodd"
                  ...
                  <svg aria-label="Perfil" className="_8-yf5 " fill="#262626"
